package com.java_api_crud.kaiburr.service;
import java.util.*;

import com.java_api_crud.kaiburr.model.Task;
import com.java_api_crud.kaiburr.repository.TaskRepository;
...
public class TaskService {
    ...
    public List<Task> getTaskBySeverity(int severity){
        return  repository.findBySeverity(severity);//Severity(severity);
    }
